...
export default function SharePage() {
  ...
  useEffect(() => {
    ...
    // tombstone keyed on the fragment's hash so a revisit refuses
    // even if the user copy-pasted the URL into a new tab. Doesn't
    // protect against multiple devices opening the same URL — that's
    // the inherent limit of a backend-less share.
    if (decoded.burn) {
      if (isShareLinkBurned(frag)) {
