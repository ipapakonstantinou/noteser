import { ChevronDoubleLeftIcon, ChevronDoubleRightIcon, PlusIcon, FolderPlusIcon } from "@heroicons/react/24/outline";

const SideHeader = ({ isCollapsed, toggleSidebar, onAddNewNote, onAddNewFolder }) => {
  return (
    <>
      {/* App Title */}
