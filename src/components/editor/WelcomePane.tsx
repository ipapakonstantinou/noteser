  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto" data-testid="welcome-pane">
      <div className="max-w-3xl mx-auto px-8 py-10 space-y-10">
        ...
        {/* Live-preview editing. Was an animated clip until the recording
            turned out to show a real private repo — see the note above the
            source-control shot below. */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/screenshots/help/editor-live-preview.png"
          alt="A note open in live preview: Markdown headings, tasks, tags, and a wikilink"
        ...
        {/* Feature demos. One per surface so a new user scrolls through the
            whole product in 30 seconds. Plain <img> on purpose: next/image
            does not animate GIFs. All lazy-loaded so weight is fine on mobile.
            The source-control shot is a still generated by
            `e2e/_help-screenshots.spec.ts` against a fake `acme/notes-vault`:
            this pane is served to every visitor, so the asset must not carry a
            real repo name. */}
        <section aria-labelledby="welcome-git">
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/screenshots/help/source-control-panel.png" alt="The source-control panel: Commit &amp; Sync, three pending changes, and the recent commits list" className="w-full rounded-lg border border-obsidianBorder shadow-obsidian" loading="lazy" />
        </section>
