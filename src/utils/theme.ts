...
export const THEME_TOKENS: readonly ThemeToken[] = [
  ...
  { cssVar: 'obsidian-highlight',       tailwind: 'obsidianHighlight',      label: 'Hover surface',      defaultColor: '#4d4d4d' },
  { cssVar: 'obsidian-selection',       tailwind: 'obsidianSelection',      label: 'Editor selection',   defaultColor: '#2b5a9b' },
